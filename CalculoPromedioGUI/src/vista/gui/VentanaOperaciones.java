	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==btnCalcular) {
			...
			String documento = txtDocumento.getText();
			 ...
			 if (verificarEstudianteDuplicado(documento)) {
	                JOptionPane.showMessageDialog(this, "El estudiante ya existe", "Error", JOptionPane.ERROR_MESSAGE);
	                
			 } else {
				 String nombre = txtNombre.getText();
	                listaEstudiantes.add(new EstudianteVO(nombre, documento));
	                JOptionPane.showMessageDialog(this, "Estudiante agregado exitosamente", "Información", JOptionPane.INFORMATION_MESSAGE);
	            }
			 }
			...
			private void mostrarListaEstudiantes() {
			    ...
			    for (EstudianteVO estudiante : listaEstudiantes) {
			        lista.append("Nombre: ").append(estudiante.getNombre()).append(", Documento: ").append(estudiante.getDocumento()).append("\n");
			    }
			    JOptionPane.showMessageDialog(this, lista.toString(), "Lista de Estudiantes", JOptionPane.INFORMATION_MESSAGE);
			}
		}
